    ...
    return (
        <aside className="sidebar z-10 sm:z-0 block min-h-screen fixed left-0 pb-14 max-h-screen w-3/4 sm:w-1/5 bg-gray-800 text-white overflow-x-hidden border-r">
                        ...
                        <div key={index}>
                            {label === "Logout" ? (
                                <button
                                    ...
                                    className="hover:bg-gray-700 flex gap-3 items-center py-3 px-4 font-medium w-full text-left"
                                >
                                    <span>{icon}</span>
                                    <span>{label}</span>
                                </button>
            ...
            <div className="flex flex-col gap-1 bg-gray-700 p-3 rounded-lg shadow-lg mb-6 mt-28 mx-3.5 overflow-hidden">
                ...
                <div className="flex flex-col gap-0">
                    <a
                        href="https://www.linkedin.com/in/mohd-nawaz-khan-778895326"
                        target="_blank"
                        rel="noreferrer"
                    ...
                    <a
                        href="mailto:khanmohdnawaz567@gmail.com"
                        className="text-gray-300 text-sm hover:text-blue-500"
                    >
                        khanmohdnawaz567@gmail.com
                    </a>
                </div>
            </div>
